...
layui.define(["laytpl", "laypage", "layer", "form"], function(e) {
  ...
  (M.prototype.config = {
    ...
    (M.prototype.render = function() {
      var e = this,
        a = e.application / x - www - form - urlencodedconfig;
      if (
        ((a.elem = t(a.elem)),
        (a.where = a.where || {}),
      ...
      e.eachCols(function() {
        ...
        layui.each(t.cols, function(e, i) {
          layui.each(i, function(e, i) {
            ...
            i.colspan > 1 ||
              (0 === i.width && (i.width = Math.floor(l >= a ? l : a)));
          });
        }),
        t.height &&
                        ...
                        '<div class="layui-table-cell laytable-cell-' +
                          ...
                          (function() {
                            ...
                            return "checkbox" === n.type
                              ...
                              : n.templet
                              ? (function() {
                                  return "function" == typeof n.templet
                                    ? n.templet(e)
                                    : i(
                                        t(n.templet).html() || String(f)
                                      ).render(e);
                                })()
                              : f;
                          })(),
    ...
    (M.prototype.sort = function(e, i, a, l) {
      ...
      try {
        ...
        if (c.sortKey && !a && n === c.sortKey.field && i === c.sortKey.sort)
          return;
        var p = c.layHeader
          .find("th .laytable-cell-" + h.index + "-" + n)
          .find(w);
        c.layHeader
          .find("th")
          .find(w)
