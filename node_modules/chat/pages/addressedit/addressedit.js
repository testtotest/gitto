    ...
    onLoad: function (options) {
		wx.getStorage({
		   key: 'userName',		     
					  ...
					  {				
						 wx.redirectTo({
							url:'/pages/form/islogin?lm=addr'
						 })				 
					  }
		})
        wx.removeStorageSync('areaArray')
