...
Page({
  ...
  data: {
	...
	itemsc: [{
	 ...
	 showpicaModal: true,
	 showpicbModal: false,
	 iaa:"/images/zheng@2x.png",
	 ibb:"/images/fan@2x.png",
  ...
  formModal:function (){
	 ...
	 wx.request({
	     ...
	     data: {
	 		...
	 		equityProveType:"0",   //that.data.isshowd 产权证明类型
	 		documentType: "0",     //that.data.isshowc 法人证件类型
