...
Page({
  ...
  formModal:function (){
	 var _this = this;
	 // console.log(_this.data.isshowd)
	 // console.log(_this.data.isshowc)
	 // console.log(_this.data.imgz)
	 // console.log(_this.data.ownerName)
	 // console.log(_this.data.ownerIdCard)
	 // console.log(_this.data.applicantPhone)
