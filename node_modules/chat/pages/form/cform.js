...
Page({
				...
				for (var i = 0; i < tempFilePaths.length; i++) {
				  if (imgs.length >= 9) {
					...
					return false;
					 ...
					 var reto=that.toBase(tempFilePaths[i]); 					
  ...
  toBase: function (e) {	 
	   wx.getFileSystemManager().readFile({
		  ...
		  encoding: "base64",		 
		  success: res => {
			  wx.setStorageSync("tbase",res.data)
			  ///////////////// return res.data;
			  // wx.request({				         
	  ...
	  return wx.getStorageSync("tbase");
  },
  // 删除图片
    ...
    addForm:function(e){
		...
		wx.request({
		    ...
		    data: {
				...
				equityProveList: that.data.imgz, //List
				authorizationPhoto: that.data.imgd,
				identityProveList: that.data.imgf, //List
		    },			
		    success(res){
